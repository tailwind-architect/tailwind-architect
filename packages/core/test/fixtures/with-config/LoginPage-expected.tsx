    ...
    <main className="flex flex-col items-center justify-center min-h-screen px-4 bg-muted/30">
      <div className="w-full max-w-sm space-y-8">
        ...
        <form
          ...
          className="space-y-4 p-6 rounded-lg border border-border bg-card shadow-sm"
        >
          <div>
            <label
              htmlFor="email"
              className="block mb-1 font-medium text-sm text-foreground"
            >
              E-mail
            </label>
            <input
