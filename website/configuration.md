...
Plugins add custom lint rules, sort groups, and suggestions. See [Extensibility](https://github.com/tailwind-architect/tailwind-architect/blob/main/docs/extensibility.md#plugin-system) and `examples/example-plugin` in the repo.
