...
For very large repos, reduce concurrency: `--max-workers 2`. See [Performance](https://github.com/tailwind-architect/tailwind-architect/blob/main/docs/performance.md).
